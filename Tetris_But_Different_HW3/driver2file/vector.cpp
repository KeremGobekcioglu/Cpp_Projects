...
vec1d::vec1d(const vec1d &obj) // copy constructor
{
	this->capacitycolumn = obj.capacitycolumn;
...
void vec1d::pushback(char var) // regular pushback
{
...
void vec1d::Resize(int var1) // i dont use this
{
...
ostream &operator<<(ostream &anan, const vec1d &obj) // overloaded the operators for easy printing
{
...
vec2d::vec2d(const vec2d &other) // copy constructor
{
	*this = other;
}
...
void vec2d::push(const vec1d &other) // works like a 2d vector
{
